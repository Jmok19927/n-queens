 ...
 */
    ...
    hasRowConflictAt: function(rowIndex) {
      //look at one specific row;
      var currentRow = this.rows()[rowIndex]; // get specific row that we're looking at
      var count = 0;
      //iterate over current row
      for (let i = 0; i < currentRow.length; i++) {
      //the first instance of 1 set firstPiece to indexOf first instance
        if (currentRow[i] === 1) {
          count++;
        }
      //if another instance of 1 arises return true
        if (count > 1) {
          return true
        }
      //count every instance of '1'
      //return if count > 1
      }
      return false;
    ...
    hasAnyMinorDiagonalConflicts: function() {
      ...
      for (let i = 0; i < size; i++) {
        ...
        if (this.hasMinorDiagonalConflictAt(size - 1, i)) {
          return true;
        }
      }
      return false;
